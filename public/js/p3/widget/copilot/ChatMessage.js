define([
  ...
  return declare(null, {
    ...
    renderUserOrAssistantMessage: function(messageDiv) {
      ...
      // Data query, workspace browse, jobs browse, and file metadata
      // cards have been removed — agents now include actionable markdown
      // links directly in their text responses.
